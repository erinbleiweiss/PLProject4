...
# 2)
print("\n2)")
print "select last_name, first_name, tile, salary from s_emp: "
...
# 4)
print("\n4)")
print "select last_name, first_name, title, salary from s_emp where salary > 1500 and dept id > 40 order by last_name: "
